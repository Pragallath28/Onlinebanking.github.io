	...
	public void contextInitialized(ServletContextEvent arg0) {
      ...
      try{
       ...
       if(status==0)
		...
		PreparedStatement ps=con.prepareStatement("CREATE TABLE NEWACCOUNT(ACCOUNTNO NUMBER,USERNAME VARCHAR(4000),PASSWORD VARCHAR(4000),REPASSWORD VARCHAR(4000),AMOUNT NUMBER,ADDRESS VARCHAR(4000),PHONE NUMBER,PRIMARY KEY (ACCOUNTNO))");
		ps.executeUpdate();
